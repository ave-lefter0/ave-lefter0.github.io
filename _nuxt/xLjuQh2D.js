import{c9 as e,cd as t,cq as i,co as n,cj as r,hT as o,ce as s,ca as a,cb as l,ch as c,cf as u,eE as d,ci as h,cl as p,cm as w,cn as f}from"./3ptQIBJb.js";import{n as g,r as m,o as v}from"./LgAAmdpy.js";import{c as x,U as k}from"./nddBALH4.js";import"./D4Z0BSxx.js";import"./CwO4hvnm.js";import{e as b,n as y}from"./DGDTTLgu.js";import"./D0MC3uiJ.js";import{n as $,s as A}from"./Dm1rYZ30.js";import"./_d8xReMN.js";import"./DeVfG48s.js";import{S as T}from"./JqUad-XW.js";import"./D0oan3tr.js";import"./BmzDTsIu.js";import"./DXAmvGyj.js";import"./ByssTI6i.js";import"./DpsQTQI6.js";import"./tPawBPYT.js";import"./1UqPZgvr.js";const C=e`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let S=class extends t{constructor(){super(...arguments),this.inputElementRef=b(),this.disabled=!1,this.value="",this.placeholder="0"}render(){return this.inputElementRef?.value&&this.value&&(this.inputElementRef.value.value=this.value),s`<input
      ${y(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
    ...
    /> `}dispatchInputChangeEvent(e){const t=e.data;if(t&&this.inputElementRef?.value)if(","===t){const e=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=e,this.value=`${this.value}${e}`}else $.test(t)||(this.inputElementRef.value.value=this.value.replace(new RegExp(t.replace(A,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};S.styles=[a,l,N],j([g({type:Boolean})],S.prototype,"disabled",void 0),j([g({type:String})],S.prototype,"value",void 0),j([g({type:String})],S.prototype,"placeholder",void 0),S=j([x("wui-input-amount")],S);const E=e`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
...
`;var z=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let D=class extends t{constructor(){super(),this.unsubscribe=[],this.token=o.state.token,this.sendTokenAmount=o.state.sendTokenAmount,this.receiverAddress=o.state.receiverAddress,this.receiverProfileName=o.state.receiverProfileName,this.loading=o.state.loading,this.message="Preview Send",this.token&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(o.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return this.getMessage(),s` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
    ...
    </wui-flex>`}async fetchBalances(){await o.fetchTokenBalance(),o.fetchNetworkBalance()}async fetchNetworkPrice(){await T.getNetworkTokenPrice()}onButtonClick(){c.push("WalletSendPreview")}getMessage(){if(this.message="Preview Send",this.receiverAddress&&!i.isAddress(this.receiverAddress,n.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&this.token?.price){this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")}this.token||(this.message="Select Token")}};D.styles=O,z([m()],D.prototype,"token",void 0),z([m()],D.prototype,"sendTokenAmount",void 0),z([m()],D.prototype,"receiverAddress",void 0),z([m()],D.prototype,"receiverProfileName",void 0),z([m()],D.prototype,"loading",void 0),z([m()],D.prototype,"message",void 0),D=z([x("w3m-wallet-send-view")],D);const U=e`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var V=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let H=class extends t{constructor(){super(),this.unsubscribe=[],this.tokenBalances=o.state.tokenBalances,this.search="",this.onDebouncedSearch=i.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(o.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}async fetchBalancesAndNetworkPrice(){this.tokenBalances&&0!==this.tokenBalances?.length||(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await o.fetchTokenBalance(),o.fetchNetworkBalance()}async fetchNetworkPrice(){await T.getNetworkTokenPrice()}templateSearchInput(){return s`
    ...
    `}onBuyClick(){c.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){o.setToken(e),o.setTokenAmount(void 0),c.goBack()}};H.styles=U,V([m()],H.prototype,"tokenBalances",void 0),V([m()],H.prototype,"tokens",void 0),V([m()],H.prototype,"filteredTokens",void 0),V([m()],H.prototype,"search",void 0),H=V([x("w3m-wallet-send-select-token-view")],H);const q=e`
  :host {
    display: flex;
...
`;var L=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let F=class extends t{constructor(){super(...arguments),this.text="",this.address="",this.isAddress=!1}render(){return s`<wui-text variant="large-500" color="fg-100">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.isAddress?s`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?s`<wui-image src=${this.imageSrc}></wui-image>`:s`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`}};F.styles=[a,l,q],L([g()],F.prototype,"text",void 0),L([g()],F.prototype,"address",void 0),L([g()],F.prototype,"imageSrc",void 0),L([g({type:Boolean})],F.prototype,"isAddress",void 0),F=L([x("wui-preview-item")],F);const W=e`
  :host {
    display: flex;
...
`;var K=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let J=class extends t{render(){return s` <wui-text variant="small-400" color="fg-200">Details</wui-text>
      <wui-flex flexDirection="column" gap="xxs">
        <wui-list-content
          textTitle="Address"
          textValue=${k.getTruncateString({string:this.receiverAddress??"",charsStart:4,charsEnd:4,truncate:"middle"})}
        >
        </wui-list-content>
        ...
        class="network"
        textTitle="Network"
        imageSrc=${v(d.getNetworkImage(this.caipNetwork))}
      ></wui-list-content>`:null}onNetworkClick(e){e&&c.push("Networks",{network:e})}};J.styles=_,K([g()],J.prototype,"receiverAddress",void 0),K([g({type:Object})],J.prototype,"caipNetwork",void 0),J=K([x("w3m-wallet-send-details")],J);const Q=e`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;var X=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let G=class extends t{constructor(){super(),this.unsubscribe=[],this.token=o.state.token,this.sendTokenAmount=o.state.sendTokenAmount,this.receiverAddress=o.state.receiverAddress,this.receiverProfileName=o.state.receiverProfileName,this.receiverProfileImageUrl=o.state.receiverProfileImageUrl,this.caipNetwork=n.state.activeCaipNetwork,this.loading=o.state.loading,this.unsubscribe.push(o.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),n.subscribeKey("activeCaipNetwork",e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
      <wui-flex gap="xs" flexDirection="column" .padding=${["0","xs","0","xs"]}>
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.sendTokenAmount?k.roundNumber(this.sendTokenAmount,6,5):"unknown"} ${this.token?.symbol}"
            .imageSrc=${this.token?.iconUrl}
          ></wui-preview-item>
        </wui-flex>
        <wui-flex>
        ...
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.receiverProfileName?k.getTruncateString({string:this.receiverProfileName,charsStart:20,charsEnd:0,truncate:"end"}):k.getTruncateString({string:this.receiverAddress?this.receiverAddress:"",charsStart:4,charsEnd:4,truncate:"middle"})}"
