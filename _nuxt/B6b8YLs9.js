...
`;var F=function(t,e,r,i){var n,s=arguments.length,a=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,r,i);else for(var o=t.length-1;o>=0;o--)(n=t[o])&&(a=(s<3?n(a):s>3?n(e,r,a):n(e,r))||a);return s>3&&a&&Object.defineProperty(e,r,a),a};let L=class extends r{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:""}}render(){const[t,e]=this.images,r="NFT"===t?.type,n=r?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)",s=(e?.url?"NFT"===e.type:r)?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)";return this.style.cssText=`\n    --local-left-border-radius: ${n};\n    --local-right-border-radius: ${s};\n    `,i`<wui-flex> ${this.templateVisual()} ${this.templateIcon()} </wui-flex>`}templateVisual(){const[t,e]=this.images,r=t?.type;return 2===this.images.length&&(t?.url||e?.url)?i`<div class="swap-images-container">
      ...
      ></wui-icon-box>
    `:null}getDirectionIcon(){switch(this.direction){case"in":return"arrowBottom";case"out":return"arrowTop";default:return}}getIcon(){return this.onlyDirectionIcon?this.getDirectionIcon():"trade"===this.type?"swapHorizontalBold":"approve"===this.type?"checkmark":"cancel"===this.type?"close":this.getDirectionIcon()}getStatusColor(){switch(this.status){case"confirmed":return"success-100";case"failed":return"error-100";case"pending":return"inverse-100";default:return"accent-100"}}};L.styles=[P],F([h()],L.prototype,"type",void 0),F([h()],L.prototype,"status",void 0),F([h()],L.prototype,"direction",void 0),F([h({type:Boolean})],L.prototype,"onlyDirectionIcon",void 0),F([h({type:Array})],L.prototype,"images",void 0),F([h({type:Object})],L.prototype,"secondImage",void 0),L=F([y("wui-transaction-visual")],L);const H=e`
...
`;var U=function(t,e,r,i){var n,s=arguments.length,a=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,r,i);else for(var o=t.length-1;o>=0;o--)(n=t[o])&&(a=(s<3?n(a):s>3?n(e,r,a):n(e,r))||a);return s>3&&a&&Object.defineProperty(e,r,a),a};let z=class extends r{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return i`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
          direction=${f(this.direction)}
          type=${this.type}
          onlyDirectionIcon=${f(this.onlyDirectionIcon)}
          .images=${this.images}
        ></wui-transaction-visual>
    ...
    `}templateDescription(){const t=this.descriptions?.[0];return t?i`
        ...
        `:null}};z.styles=[n,H],U([h()],z.prototype,"type",void 0),U([h({type:Array})],z.prototype,"descriptions",void 0),U([h()],z.prototype,"date",void 0),U([h({type:Boolean})],z.prototype,"onlyDirectionIcon",void 0),U([h()],z.prototype,"status",void 0),U([h()],z.prototype,"direction",void 0),U([h({type:Array})],z.prototype,"images",void 0),U([h({type:Array})],z.prototype,"price",void 0),U([h({type:Array})],z.prototype,"amount",void 0),U([h({type:Array})],z.prototype,"symbol",void 0),z=U([y("wui-transaction-list-item")],z);const E=e`
  :host > wui-flex:first-child {
    column-gap: var(--wui-spacing-s);
...
`;let J=class extends r{render(){return i`
    ...
    `}};J.styles=[n,E],J=function(t,e,r,i){var n,s=arguments.length,a=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,r,i);else for(var o=t.length-1;o>=0;o--)(n=t[o])&&(a=(s<3?n(a):s>3?n(e,r,a):n(e,r))||a);return s>3&&a&&Object.defineProperty(e,r,a),a}([y("wui-transaction-list-item-loader")],J);const V=e`
  :host {
    min-height: 100%;
  }
...
`;var W=function(t,e,r,i){var n,s=arguments.length,a=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,r,i);else for(var o=t.length-1;o>=0;o--)(n=t[o])&&(a=(s<3?n(a):s>3?n(e,r,a):n(e,r))||a);return s>3&&a&&Object.defineProperty(e,r,a),a};const q="last-transaction";let G=class extends r{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page="activity",this.caipAddress=s.state.activeCaipAddress,this.transactionsByYear=a.state.transactionsByYear,this.loading=a.state.loading,this.empty=a.state.empty,this.next=a.state.next,a.clearCursor(),this.unsubscribe.push(s.subscribeKey("activeCaipAddress",t=>{t&&this.caipAddress!==t&&(a.resetTransactions(),a.fetchTransactions(t)),this.caipAddress=t}),s.subscribeKey("activeCaipNetwork",()=>{this.updateTransactionView()}),a.subscribe(t=>{this.transactionsByYear=t.transactionsByYear,this.loading=t.loading,this.empty=t.empty,this.next=t.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return i` ${this.empty?null:this.templateTransactionsByYear()}
    ...
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){a.resetTransactions(),this.caipAddress&&a.fetchTransactions(o.getPlainAddress(this.caipAddress))}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(t=>{const e=parseInt(t,10),r=new Array(12).fill(null).map((t,r)=>{const i=N.getTransactionGroupTitle(e,r),n=this.transactionsByYear[e]?.[r];return{groupTitle:i,transactions:n}}).filter(({transactions:t})=>t).reverse();return r.map(({groupTitle:t,transactions:e},n)=>{const s=n===r.length-1;return e?i`
        ...
        <wui-transaction-list-item
          ...
          .descriptions=${n}
        ></wui-transaction-list-item>
      `:d?u.map((t,n)=>{const s=N.getTransferDescription(t),a=e&&n===u.length-1;return i` <wui-transaction-list-item
          date=${r}
