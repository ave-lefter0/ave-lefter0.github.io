import{n as t,Y as e,t as r,p as a,O as o,s}from"./DfntAQVk.js";var i=Object.defineProperty,h=Object.getOwnPropertyDescriptor,p=(t,e,r,a)=>{for(var o,s=a>1?void 0:a?h(e,r):e,p=t.length-1;p>=0;p--)(o=t[p])&&(s=(a?o(e,r,s):o(s))||s);return a&&s&&i(e,r,s),s};let l=class extends t{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return e`<svg
  ...
  `,p([o({type:String,reflect:!0})],l.prototype,"size",2),p([o({type:String,reflect:!0})],l.prototype,"weight",2),p([o({type:String,reflect:!0})],l.prototype,"color",2),p([o({type:Boolean,reflect:!0})],l.prototype,"mirrored",2),l=p([s("ph-dots-three")],l);export{l as PhDotsThree};
