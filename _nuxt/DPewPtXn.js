import{c9 as e,cd as t,hM as i,hN as r,eD as o,ce as s,dE as a,co as n,eE as c,cl as l,cm as u,cn as p,ch as d,cq as h,cj as m,eF as w,ci as g,cv as y}from"./3ptQIBJb.js";import{o as f,r as b,n as v}from"./LgAAmdpy.js";import{c as x}from"./nddBALH4.js";import"./OtI9-muE.js";import{O as C}from"./BT67ZCzU.js";import"./D0MC3uiJ.js";import"./ByssTI6i.js";import"./DpsQTQI6.js";import"./lVIlXRlO.js";import"./_d8xReMN.js";import"./D4Z0BSxx.js";import"./CwO4hvnm.js";import"./BxzIr_gC.js";import"./D0oan3tr.js";import"./DGDTTLgu.js";import"./tPawBPYT.js";import"./Dm1rYZ30.js";const k=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var $=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let R=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=i.state.paymentCurrency,this.currencies=i.state.paymentCurrencies,this.currencyImages=r.state.currencyImages,this.checked=C.state.isLegalCheckboxChecked,this.unsubscribe.push(i.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),r.subscribeKey("currencyImages",e=>this.currencyImages=e),C.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=o.state,i=o.state.features?.legalCheckbox,r=Boolean(e||t)&&Boolean(i)&&!this.checked;return s`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>s`
        <wui-list-item
          imageSrc=${f(this.currencyImages?.[t.id])}
      ...
      `)}selectCurrency(e){e&&(i.setPaymentCurrency(e),a.close())}};R.styles=k,$([b()],R.prototype,"selectedCurrency",void 0),$([b()],R.prototype,"currencies",void 0),$([b()],R.prototype,"currencyImages",void 0),$([b()],R.prototype,"checked",void 0),R=$([x("w3m-onramp-fiat-select-view")],R);const P=e`
  button {
      ...
      <wui-flex class="networks">
        ${t?.map(e=>s`
            <wui-flex class="network-icon">
              <wui-image src=${f(c.getNetworkImage(e))}></wui-image>
            </wui-flex>
          `)}
      </wui-flex>
    `}};I.styles=[P],j([v({type:Boolean})],I.prototype,"disabled",void 0),j([v()],I.prototype,"color",void 0),j([v()],I.prototype,"name",void 0),j([v()],I.prototype,"label",void 0),j([v()],I.prototype,"feeRange",void 0),j([v({type:Boolean})],I.prototype,"loading",void 0),j([v()],I.prototype,"onClick",void 0),I=j([x("w3m-onramp-provider-item")],I);const O=e`
  wui-flex {
...
`;var E=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let U=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=i.state.purchaseCurrencies,this.tokens=i.state.purchaseCurrencies,this.tokenImages=r.state.tokenImages,this.checked=C.state.isLegalCheckboxChecked,this.unsubscribe.push(i.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),r.subscribeKey("tokenImages",e=>this.tokenImages=e),C.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=o.state,i=o.state.features?.legalCheckbox,r=Boolean(e||t)&&Boolean(i)&&!this.checked;return s`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>s`
        <wui-list-item
          imageSrc=${f(this.tokenImages?.[t.symbol])}
      ...
      `)}selectToken(e){e&&(i.setPurchaseCurrency(e),a.close())}};U.styles=B,E([b()],U.prototype,"selectedCurrency",void 0),E([b()],U.prototype,"tokens",void 0),E([b()],U.prototype,"tokenImages",void 0),E([b()],U.prototype,"checked",void 0),U=E([x("w3m-onramp-token-select-view")],U);const S=e`
  @keyframes shake {
    0% {
...
`;var L=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let F=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=i.state.selectedProvider,this.uri=m.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(i.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){let e="Continue in external window";this.error?e="Buy failed":this.selectedOnRampProvider&&(e=`Buy in ${this.selectedOnRampProvider?.label}`);const t=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return s`
    ...
    `}onTryAgain(){this.selectedOnRampProvider&&(this.error=!1,h.openHref(this.selectedOnRampProvider.url,"popupWindow","width=600,height=800,scrollbars=yes"))}tryAgainTemplate(){return this.selectedOnRampProvider?.url?s`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
    </wui-button>`:null}loaderTemplate(){const e=w.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return s`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}onCopyUri(){if(!this.selectedOnRampProvider?.url)return g.showError("No link found"),void d.goBack();try{h.copyToClopboard(this.selectedOnRampProvider.url),g.showSuccess("Link copied")}catch{g.showError("Failed to copy")}}};F.styles=S,L([b()],F.prototype,"intervalId",void 0),L([b()],F.prototype,"selectedOnRampProvider",void 0),L([b()],F.prototype,"uri",void 0),L([b()],F.prototype,"ready",void 0),L([b()],F.prototype,"showRetry",void 0),L([b()],F.prototype,"buffering",void 0),L([b()],F.prototype,"error",void 0),L([v({type:Boolean})],F.prototype,"isMobile",void 0),L([v()],F.prototype,"onRetry",void 0),F=L([x("w3m-buy-in-progress-view")],F);let z=class extends t{render(){return s`
      <wui-flex
        flexDirection="column"
    ...
    `:null}receiveTemplate(){return Boolean(this.features?.receive)?s`
      ...
      ></wui-list-description>
    `:null}onBuyCrypto(){d.push("OnRampProviders")}onReceive(){d.push("WalletReceive")}onDepositFromExchange(){d.push("PayWithExchange")}};N([b()],W.prototype,"namespace",void 0),N([b()],W.prototype,"features",void 0),N([b()],W.prototype,"remoteFeatures",void 0),W=N([x("w3m-fund-wallet-view")],W);const K=e`
  :host {
    width: 100%;
  }
...
`;var _=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let q=class extends t{constructor(){super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=this.currencies?.[0],this.currencyImages=r.state.currencyImages,this.tokenImages=r.state.tokenImages,this.unsubscribe.push(i.subscribeKey("purchaseCurrency",e=>{e&&"Fiat"!==this.type&&(this.selectedCurrency=this.formatPurchaseCurrency(e))}),i.subscribeKey("paymentCurrency",e=>{e&&"Token"!==this.type&&(this.selectedCurrency=this.formatPaymentCurrency(e))}),i.subscribe(e=>{"Fiat"===this.type?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),r.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){i.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.selectedCurrency?.symbol||"",t=this.currencyImages[e]||this.tokenImages[e];return s`<wui-input-text type="number" size="lg" value=${this.value}>
      ${this.selectedCurrency?s` <wui-flex
          ...
          >
            <wui-image src=${f(t)}></wui-image>
            <wui-text color="fg-100">${this.selectedCurrency.symbol}</wui-text>
          </wui-flex>`:s`<wui-loading-spinner></wui-loading-spinner>`}
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};q.styles=K,_([v({type:String})],q.prototype,"type",void 0),_([v({type:Number})],q.prototype,"value",void 0),_([b()],q.prototype,"currencies",void 0),_([b()],q.prototype,"selectedCurrency",void 0),_([b()],q.prototype,"currencyImages",void 0),_([b()],q.prototype,"tokenImages",void 0),q=_([x("w3m-onramp-input")],q);const M=e`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
...
`;var Q=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};const Y={USD:"$",EUR:"€",GBP:"£"},H=[100,250,500,1e3];let X=class extends t{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=n.state.activeCaipAddress,this.loading=a.state.loading,this.paymentCurrency=i.state.paymentCurrency,this.paymentAmount=i.state.paymentAmount,this.purchaseAmount=i.state.purchaseAmount,this.quoteLoading=i.state.quotesLoading,this.unsubscribe.push(n.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),a.subscribeKey("loading",e=>{this.loading=e}),i.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}templateButton(){return this.caipAddress?s`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||a.open({view:"OnRampProviders"})}openModal(){a.open({view:"Connect"})}async onPaymentAmountChange(e){i.setPaymentAmount(Number(e.detail)),await i.getQuote()}async selectPresetAmount(e){i.setPaymentAmount(e),await i.getQuote()}};X.styles=M,Q([v({type:Boolean})],X.prototype,"disabled",void 0),Q([b()],X.prototype,"caipAddress",void 0),Q([b()],X.prototype,"loading",void 0),Q([b()],X.prototype,"paymentCurrency",void 0),Q([b()],X.prototype,"paymentAmount",void 0),Q([b()],X.prototype,"purchaseAmount",void 0),Q([b()],X.prototype,"quoteLoading",void 0),X=Q([x("w3m-onramp-widget")],X);export{F as W3mBuyInProgressView,W as W3mFundWalletView,D as W3mOnRampProvidersView,R as W3mOnrampFiatSelectView,U as W3mOnrampTokensView,X as W3mOnrampWidget,z as W3mWhatIsABuyView};
